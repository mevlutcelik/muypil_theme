...
@section('title', 'Muypil - '. __('theme2-dashboard-global.my-profile') .' - ' . 'Ad Soyad') {{--TODO: Ad Soyad yazan kısım kullanıcının adı ve soyadı olarak güncellenecek--}}
...
@section('content')
    ...
    @include('theme2.pages.dashboard.sections.my-profile-view')
