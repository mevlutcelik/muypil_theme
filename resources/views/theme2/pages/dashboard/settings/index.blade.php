...
@section('title', 'Muypil - '. __('theme2-dashboard-global.settings') .' - ' . 'Ad Soyad') {{--TODO: Ad Soyad yazan kısım kullanıcının adı ve soyadı olarak güncellenecek--}}
...
@section('content')
    ...
    @include('theme2.pages.dashboard.sections.settings-content')
