@push('styles')
    <style>
        ...
        .st2{fill:#34A852;}
        .st3{fill:#E1C025;}
        #accounts:hover .google-ads-icon {
            opacity: 0.7;
        }
                ...
                <div class="navbar-other" style="margin-right: 1rem;">
                    <ul class="navbar-nav flex-row align-items-center">
                        <li class="nav-item dropdown language-select text-uppercase">
                            <a class="nav-link dropdown-item dropdown-toggle fs-14" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">359-138-6843</a>
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="dropdown-item" href="#">359-138-6843</a></li>
            ...
            <div class="navbar-collapse-wrapper d-flex flex-row align-items-center w-100">
                <div class="navbar-collapse offcanvas bg-pale-aqua offcanvas-nav offcanvas-start">
                    <div class="offcanvas-header mx-lg-auto order-0 order-lg-1 d-lg-flex px-lg-15">
                        ...
                        <a class="muypil-logo" href="{{route('home')}}" style="font-size: 2px;position: relative;">
                            <h1 class="logo-text header-logo-text">MUYPIL</h1>
                            <section class="logo-container">
                                <div class="logo-center header-logo-center"></div>
                                <article class="blue-ring logo-ring1">
		...
		c-1.9-14,0.9-27,8.1-39.1c1.5-2.6,3.2-5,4.9-7.6C-311.2,347.6-311.5,346.5-310.2,346.5"/>
                    ...
                    <div class="w-100 order-3 order-lg-2 d-lg-flex offcanvas-body">
                        <ul class="navbar-nav me-lg-auto">
                            <li class="nav-item dropdown">
                                <a class="nav-link"
                                   href="#">{{__('theme2-dashboard-global.analytics')}}</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link"
