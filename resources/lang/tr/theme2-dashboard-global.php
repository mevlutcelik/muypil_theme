...
return [
    ...
    "personal-settings"                 => "Kullacını Ayarları",
    "accounts-accesses"                 => "Erişim Bilgileri",
    "current-password"                  => "Önceki Şifre",
    "new-password"                      => "Yeni Şifre",
    "password-confirmation"             => "Yeni Şifre Tekrarı",
    "local-time-zone"                   => "Yerel Saat",
    "local-time-zone-desc"              => "Yerel Saat Seç",
    "currency"                          => "Para Birimi",
    "currency-desc"                     => "Para Birimi Seç",
    "language-desc"                     => "Dil Değiştir",
    "freezing-account"                  => "Hesabı Dondurma",
    "freezing-account-desc"             => "Bu hesaptan gelen tüm işlemleri ve bildirimleri durdurun",
